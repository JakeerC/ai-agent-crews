...
class TheMarketingCrew:
    ...
    def head_of_marketing(self) -> Agent:
        return Agent(
            ...
            tools=[
                SerperDevTool(),
                ScrapeWebsiteTool(),
                DirectoryReadTool("resources/marketing_crew/drafts"),
                FileWriterTool(),
                FileReadTool(),
            ],
            reasoning=True,
    ...
    def content_writer_blogs(self) -> Agent:
        return Agent(
            ...
            tools=[
                SerperDevTool(),
                ScrapeWebsiteTool(),
                DirectoryReadTool("resources/marketing_crew/drafts/blogs"),
                FileWriterTool(),
                FileReadTool(),
            ],
            inject_date=True,
    ...
    def market_research(self) -> Task:
        return Task(
            config=self.tasks_config["market_research"], agent=self.head_of_marketing()
        )
    ...
    def marketingcrew(self) -> Crew:
        ...
        return Crew(
            ...
            tasks=[
                ...
                self.prepare_marketing_strategy(),
                self.create_content_calendar(),
                self.prepare_post_drafts(),
                self.prepare_scripts_for_reels(),
                self.content_research_for_blogs(),
                self.draft_blogs(),
